...
* **[PCRE2](https://pcre.org/)** Open Source Regex Library 10.44 (in C).
...
* **JavaScript [RegExp](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp)** object from Microsoft Edge [WebView2](https://docs.microsoft.com/en-us/microsoft-edge/webview2/).
...
* **Rust** 1.84.1 crates: **[regex 1.11.1](https://docs.rs/regex)**, **[fancy\_regex](https://docs.rs/fancy-regex)** and **[regress](https://docs.rs/regress)**.
...
and included into **main** branch. (No additional installations are required).
