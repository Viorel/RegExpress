...
namespace RegExpressWPFNET.Code
{
    ...
    static class FeatureMatrixUtilities
    {
        static FeatureMatrixDetails[] AllFeatureMatrixDetails =
        {
            ...
            new FeatureMatrixDetails(  @"\R", @"Linebreak", fm => fm.Class_R ),
            ...
            new FeatureMatrixDetails(  @"\X", @"Exteded grapheme cluster", fm => fm.Class_X ),
            ...
            new FeatureMatrixDetails(  @"[\R]", @"Linebreak", fm => fm.InsideSets_Class_R ),
            ...
            new FeatureMatrixDetails(  @"[\X]", @"Exteded grapheme cluster", fm => fm.InsideSets_Class_X ),
            ...
            new FeatureMatrixDetails(  @"\b, \B", @"Boundry between \w and \W", fm => fm.Anchor_bB ),
            new FeatureMatrixDetails(  @"\b{g}", @"Unicode extended grapheme cluster boundary", fm => fm.Anchor_bg ),
            new FeatureMatrixDetails(  @"\b{…}, \B{…}", @"Typed boundry", fm => fm.Anchor_bBBrace ),
            ...
            new FeatureMatrixDetails(  @"\y, \Y", @"Boundry between graphemes", fm => fm.Anchor_yY ),
            ...
            new FeatureMatrixDetails(  @"(?n)", @"Recursive subpatern by number", fm => fm.Recursive_Num ),
            new FeatureMatrixDetails(  @"(?-n), (?+n)", @"Relative recursive subpatern by number", fm => fm.Recursive_PlusMinusNum ),
            new FeatureMatrixDetails(  @"(?R)", @"Recursive whole patern", fm => fm.Recursive_R ),
            new FeatureMatrixDetails(  @"(?&name)", @"Recursive subpatern by name", fm => fm.Recursive_Name ),
            new FeatureMatrixDetails(  @"(?P>name)", @"Recursive subpatern by name", fm => fm.Recursive_PGtName ),
