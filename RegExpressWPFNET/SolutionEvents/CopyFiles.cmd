...
xcopy /D /R /Y /E "%BasePath%\RE2JSWorker\re2js\*.*" "%EnginesTargetPath%\JavaScript\RE2JSWorker\re2js\*"
xcopy /D /R /Y "%BasePath%\RE2JSWorker\RE2JSWorker.js" "%EnginesTargetPath%\JavaScript\RE2JSWorker\*"
...
xcopy /D /R /Y "%BasePath%\RegexrWorker\target\release\RustRegexrWorker.exe" "%EnginesTargetPath%\Rust\*.bin"
xcopy /D /R /Y "%BasePath%\ReXileWorker\target\release\ReXileWorker.exe" "%EnginesTargetPath%\Rust\*.bin"
...
xcopy /D /R /Y "%BasePath%\RegExpWorker\RegExpWorker.exe" "%EnginesTargetPath%\Dart\*.bin"
xcopy /D /R /Y "%BasePath%\OnigurumaDartWorker\OnigurumaDartWorker.exe" "%EnginesTargetPath%\Dart\*.bin"
