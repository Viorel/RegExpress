...
namespace RegExpressLibrary.SyntaxColouring
{
    ...
    // ('struct', to simplify the calculation of hash code)
    {
        ...
        public bool Anchor_bB { get; init; }                               // \b, \B -- boundry between \w and \W; see also Esc_b, InsideSets_Esc_b
        public bool Anchor_bg { get; init; }                              // \b{g} -- Unicode extended grapheme cluster boundary; see also Anchor_bBBrace
        public bool Anchor_bBBrace { get; init; }                         // \b{boundry_type}, \B{boundry_type}; ex.: \b{wb}, which is almost similar to \b
