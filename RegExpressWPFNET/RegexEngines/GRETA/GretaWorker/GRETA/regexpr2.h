...
public:
    ...
    ) const
    {
        ...
        detail::static_assertG< detail::is_convertible<OtherT,IterT>::value > const iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        // convertible to type IterT. Check the declaration of your rpattern object.
        detail::static_assertG< detail::is_convertible<CharT*,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        detail::static_assertG< detail::is_convertible<iter_type,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        // convertible to type IterT. Check the declaration of your rpattern object.
        detail::static_assertG< detail::is_convertible<Char1T*,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
