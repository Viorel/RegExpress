...
template< bool f > struct static_assertG;
template<>         struct static_assertG<true> { static_assertG() {} };
...
public:
    ...
    ~hetero_stack() // throw()
    {
        ...
        detail::static_assertG< detail::is_power_of_two<AlignmentT>::value > const align_test;
    ...
    inline void push( T const & t ) // throw(std::bad_alloc,...)
    {
        ...
        detail::static_assertG<( AlignmentT >= detail::alignofG<T>::value )> const align_test;
    ...
    {
        detail::static_assertG< RuntimeTypeCheckT > const type_check;
    ...
    {
        using scoped_pop_base::m_pstack;
