    ...
    class Engine : IRegexEngine
    {
        ...
        static FeatureMatrix BuildFeatureMatrix( SyntaxEnum syntax, Details details )
        {
            ...
            return new FeatureMatrix
            {
                ...
                PositiveLookbehind = details.ONIG_SYN_OP2_QMARK_GROUP_EFFECT ? syntax == SyntaxEnum.ONIG_SYNTAX_ONIGURUMA || syntax == SyntaxEnum.ONIG_SYNTAX_JAVA ? FeatureMatrix.LookModeEnum.AnyLength : FeatureMatrix.LookModeEnum.FixedLength : FeatureMatrix.LookModeEnum.None,
                NegativeLookbehind = details.ONIG_SYN_OP2_QMARK_GROUP_EFFECT ? syntax == SyntaxEnum.ONIG_SYNTAX_ONIGURUMA || syntax == SyntaxEnum.ONIG_SYNTAX_JAVA ? FeatureMatrix.LookModeEnum.AnyLength : FeatureMatrix.LookModeEnum.FixedLength : FeatureMatrix.LookModeEnum.None,
