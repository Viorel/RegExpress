...
partial class SubengineRegexPlus( Options options ) : RegexSubengine
{
    static readonly LazyData<(bool vFlag, bool xFlag), FeatureMatrix> LazyFeatureMatrix = new( d => BuildFeatureMatrix( d.vFlag, d.xFlag ) );
    ...
    {
        FeatureMatrix fm = LazyFeatureMatrix.GetValue( (options.v, options.x) );
    ...
    static FeatureMatrix BuildFeatureMatrix( bool vFlag, bool xFlag )
    {
