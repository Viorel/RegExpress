...
namespace real::detail {
  ...
  //! \brief `\p{Ll}` — 662 ranges, 2258 code points.
  inline constexpr code_range gc_Ll_ranges[] {
    {0x0061, 0x007A},
    {0x00B5, 0x00B5},
    {0x00DF, 0x00F6},
    {0x00F8, 0x00FF},
  ...
  //! \brief `\p{Lt}` — 10 ranges, 31 code points.
  inline constexpr code_range gc_Lt_ranges[] {
    {0x01C5, 0x01C5},
    {0x01C8, 0x01C8},
    {0x01CB, 0x01CB},
    {0x01F2, 0x01F2},
  ...
  //! \brief `\p{Lm}` — 75 ranges, 404 code points.
  inline constexpr code_range gc_Lm_ranges[] {
    {0x02B0, 0x02C1},
    {0x02C6, 0x02D1},
    {0x02E0, 0x02E4},
    {0x02EC, 0x02EC},
  ...
  //! \brief `\p{Lo}` — 528 ranges, 136477 code points.
  inline constexpr code_range gc_Lo_ranges[] {
    {0x00AA, 0x00AA},
    {0x00BA, 0x00BA},
    {0x01BB, 0x01BB},
    {0x01C0, 0x01C3},
  ...
  //! \brief `\p{Mn}` — 357 ranges, 2020 code points.
  inline constexpr code_range gc_Mn_ranges[] {
    {0x0300, 0x036F},
    {0x0483, 0x0487},
    {0x0591, 0x05BD},
    {0x05BF, 0x05BF},
  ...
  //! \brief `\p{Mc}` — 190 ranges, 468 code points.
  inline constexpr code_range gc_Mc_ranges[] {
    {0x0903, 0x0903},
    {0x093B, 0x093B},
    {0x093E, 0x0940},
    {0x0949, 0x094C},
  ...
  //! \brief `\p{Me}` — 5 ranges, 13 code points.
  inline constexpr code_range gc_Me_ranges[] {
    {0x0488, 0x0489},
    {0x1ABE, 0x1ABE},
    {0x20DD, 0x20E0},
    {0x20E2, 0x20E4},
  ...
  //! \brief `\p{Nd}` — 71 ranges, 760 code points.
  inline constexpr code_range gc_Nd_ranges[] {
    {0x0030, 0x0039},
    {0x0660, 0x0669},
    {0x06F0, 0x06F9},
    {0x07C0, 0x07C9},
  ...
  //! \brief `\p{Nl}` — 12 ranges, 236 code points.
  inline constexpr code_range gc_Nl_ranges[] {
    {0x16EE, 0x16F0},
    {0x2160, 0x2182},
    {0x2185, 0x2188},
    {0x3007, 0x3007},
  ...
  //! \brief `\p{No}` — 72 ranges, 915 code points.
  inline constexpr code_range gc_No_ranges[] {
    {0x00B2, 0x00B3},
    {0x00B9, 0x00B9},
    {0x00BC, 0x00BE},
    {0x09F4, 0x09F9},
  ...
  //! \brief `\p{Pc}` — 6 ranges, 10 code points.
  inline constexpr code_range gc_Pc_ranges[] {
    {0x005F, 0x005F},
    {0x203F, 0x2040},
    {0x2054, 0x2054},
    {0xFE33, 0xFE34},
  ...
  //! \brief `\p{Pd}` — 20 ranges, 27 code points.
  inline constexpr code_range gc_Pd_ranges[] {
    {0x002D, 0x002D},
    {0x058A, 0x058A},
    {0x05BE, 0x05BE},
    {0x1400, 0x1400},
  ...
  //! \brief `\p{Ps}` — 79 ranges, 79 code points.
  inline constexpr code_range gc_Ps_ranges[] {
    {0x0028, 0x0028},
    {0x005B, 0x005B},
    {0x007B, 0x007B},
    {0x0F3A, 0x0F3A},
  ...
  //! \brief `\p{Pe}` — 76 ranges, 77 code points.
  inline constexpr code_range gc_Pe_ranges[] {
    {0x0029, 0x0029},
    {0x005D, 0x005D},
    {0x007D, 0x007D},
    {0x0F3B, 0x0F3B},
  ...
  //! \brief `\p{Pi}` — 11 ranges, 12 code points.
  inline constexpr code_range gc_Pi_ranges[] {
    {0x00AB, 0x00AB},
    {0x2018, 0x2018},
    {0x201B, 0x201C},
    {0x201F, 0x201F},
  ...
  //! \brief `\p{Pf}` — 10 ranges, 10 code points.
  inline constexpr code_range gc_Pf_ranges[] {
    {0x00BB, 0x00BB},
    {0x2019, 0x2019},
    {0x201D, 0x201D},
    {0x203A, 0x203A},
  ...
  //! \brief `\p{Po}` — 193 ranges, 640 code points.
  inline constexpr code_range gc_Po_ranges[] {
    {0x0021, 0x0023},
    {0x0025, 0x0027},
    {0x002A, 0x002A},
    {0x002C, 0x002C},
  ...
  //! \brief `\p{Sm}` — 65 ranges, 950 code points.
  inline constexpr code_range gc_Sm_ranges[] {
    {0x002B, 0x002B},
    {0x003C, 0x003E},
    {0x007C, 0x007C},
    {0x007E, 0x007E},
  ...
  //! \brief `\p{Sc}` — 21 ranges, 63 code points.
  inline constexpr code_range gc_Sc_ranges[] {
    {0x0024, 0x0024},
    {0x00A2, 0x00A5},
    {0x058F, 0x058F},
    {0x060B, 0x060B},
  ...
  //! \brief `\p{Sk}` — 31 ranges, 125 code points.
  inline constexpr code_range gc_Sk_ranges[] {
    {0x005E, 0x005E},
    {0x0060, 0x0060},
    {0x00A8, 0x00A8},
    {0x00AF, 0x00AF},
  ...
  //! \brief `\p{So}` — 187 ranges, 7376 code points.
  inline constexpr code_range gc_So_ranges[] {
    {0x00A6, 0x00A6},
    {0x00A9, 0x00A9},
    {0x00AE, 0x00AE},
    {0x00B0, 0x00B0},
  ...
  //! \brief `\p{Zs}` — 7 ranges, 17 code points.
  inline constexpr code_range gc_Zs_ranges[] {
    {0x0020, 0x0020},
    {0x00A0, 0x00A0},
    {0x1680, 0x1680},
    {0x2000, 0x200A},
  ...
  //! \brief `\p{Zl}` — 1 ranges, 1 code points.
  inline constexpr code_range gc_Zl_ranges[] {
    {0x2028, 0x2028},
  };

  //! \brief `\p{Zp}` — 1 ranges, 1 code points.
  inline constexpr code_range gc_Zp_ranges[] {
    {0x2029, 0x2029},
  };

  //! \brief `\p{Cc}` — 2 ranges, 65 code points.
  inline constexpr code_range gc_Cc_ranges[] {
    {0x0000, 0x001F},
    {0x007F, 0x009F},
  };

  //! \brief `\p{Cf}` — 21 ranges, 170 code points.
  inline constexpr code_range gc_Cf_ranges[] {
    {0x00AD, 0x00AD},
    {0x0600, 0x0605},
    {0x061C, 0x061C},
    {0x06DD, 0x06DD},
  ...
  //! \brief `\p{Co}` — 3 ranges, 137468 code points.
  inline constexpr code_range gc_Co_ranges[] {
    {0xE000, 0xF8FF},
    {0xF0000, 0xFFFFD},
    {0x100000, 0x10FFFD},
  };

  //! \brief `\p{Cn}` — 731 ranges, 819533 code points.
  inline constexpr code_range gc_Cn_ranges[] {
    {0x0378, 0x0379},
    {0x0380, 0x0383},
    {0x038B, 0x038B},
    {0x038D, 0x038D},
  ...
  //! \brief `\p{L}` — 677 ranges, 141028 code points.
  inline constexpr code_range gc_L_ranges[] {
    {0x0041, 0x005A},
    {0x0061, 0x007A},
    {0x00AA, 0x00AA},
    {0x00B5, 0x00B5},
  ...
  //! \brief `\p{M}` — 321 ranges, 2501 code points.
  inline constexpr code_range gc_M_ranges[] {
    {0x0300, 0x036F},
    {0x0483, 0x0489},
    {0x0591, 0x05BD},
    {0x05BF, 0x05BF},
  ...
  //! \brief `\p{N}` — 144 ranges, 1911 code points.
  inline constexpr code_range gc_N_ranges[] {
    {0x0030, 0x0039},
    {0x00B2, 0x00B3},
    {0x00B9, 0x00B9},
    {0x00BC, 0x00BE},
  ...
  //! \brief `\p{P}` — 198 ranges, 855 code points.
  inline constexpr code_range gc_P_ranges[] {
    {0x0021, 0x0023},
    {0x0025, 0x002A},
    {0x002C, 0x002F},
    {0x003A, 0x003B},
  ...
  //! \brief `\p{S}` — 236 ranges, 8514 code points.
  inline constexpr code_range gc_S_ranges[] {
    {0x0024, 0x0024},
    {0x002B, 0x002B},
    {0x003C, 0x003E},
    {0x005E, 0x005E},
  ...
  //! \brief `\p{Z}` — 8 ranges, 19 code points.
  inline constexpr code_range gc_Z_ranges[] {
    {0x0020, 0x0020},
    {0x00A0, 0x00A0},
    {0x1680, 0x1680},
    {0x2000, 0x200A},
  ...
  //! \brief `\p{C}` — 737 ranges, 957236 code points.
  inline constexpr code_range gc_C_ranges[] {
    {0x0000, 0x001F},
    {0x007F, 0x009F},
    {0x00AD, 0x00AD},
    {0x0378, 0x0379},
  ...
  //! \brief Range table indexed by \ref gc_property (parallel to the enum order).
  inline constexpr std::span<const code_range> gc_property_ranges[] {
    gc_Lu_ranges,
    gc_Ll_ranges,
    gc_Lt_ranges,
    gc_Lm_ranges,
...
#endif // REAL_UNICODE_PROPERTY_HPP
