...
{
    static readonly LazyData<UnicodeModeEnum, FeatureMatrix> LazyFeatureMatrix = new( unicodeMode => BuildFeatureMatrix( unicodeMode ) );
    ...
    {
        FeatureMatrix fm = LazyFeatureMatrix.GetValue( options.UnicodeMode );
    ...
    static FeatureMatrix BuildFeatureMatrix( UnicodeModeEnum unicodeMode )
    {
