...
partial class SubengineRealRegex( Options options ) : RegexSubengine
{
    static readonly LazyData<(bool useBuilder, bool isUnicode), FeatureMatrix> LazyFeatureMatrix = new( d => BuildFeatureMatrix( d.useBuilder, d.isUnicode ) );
    ...
    {
        FeatureMatrix fm = LazyFeatureMatrix.GetValue( (options.UseBuilder, options.unicode) );
    ...
    private static FeatureMatrix BuildFeatureMatrix( bool useBuilder, bool isUnicode )
    {
