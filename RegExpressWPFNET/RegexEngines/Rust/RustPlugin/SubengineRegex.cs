...
class SubengineRegex( Options options ) : RegexSubengine
{
    static readonly LazyData<(bool useBuilder, bool isOctal, bool isUnicode), FeatureMatrix> LazyFeatureMatrix =
        new( d => BuildFeatureMatrix( d.useBuilder, d.isOctal, d.isUnicode ) );
    ...
    {
        FeatureMatrix fm = LazyFeatureMatrix.GetValue( (options.UseBuilder, options.octal, options.unicode) );
    ...
    {
        Debug.Assert( options.crate == CrateEnum.regex );
        ...
        var obj = new
        {
            ...
            options = new
            {
                ...
                options.unicode,
                options.octal,
                sl = use_builder ? ValidationUtilities.ParseUInt32( "size_limit", options.size_limit ) : null,
    ...
    private static FeatureMatrix BuildFeatureMatrix( bool useBuilder, bool isOctal, bool isUnicode )
    {
        isOctal &= useBuilder;
