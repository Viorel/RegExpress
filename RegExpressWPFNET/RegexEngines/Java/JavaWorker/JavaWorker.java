    ...
    public static void main( String[] args) 
    {
        ...
        try 
        {
            ...
            case "get-version":
            {
                ...
                OutLn( JSONObject.toJSONString(result));
            ...
            {    
                ...
                int options = 0;
                if( GetBoolean( input_options, "CANON_EQ")) options |= java.util.regex.Pattern.CANON_EQ;
                if( GetBoolean( input_options, "CASE_INSENSITIVE")) options |= java.util.regex.Pattern.CASE_INSENSITIVE;
                if( GetBoolean( input_options, "COMMENTS")) options |= java.util.regex.Pattern.COMMENTS;
                if( GetBoolean( input_options, "DOTALL")) options |= java.util.regex.Pattern.DOTALL;
                if( GetBoolean( input_options, "LITERAL")) options |= java.util.regex.Pattern.LITERAL;
                if( GetBoolean( input_options, "MULTILINE")) options |= java.util.regex.Pattern.MULTILINE;
                if( GetBoolean( input_options, "UNICODE_CASE")) options |= java.util.regex.Pattern.UNICODE_CASE;
                if( GetBoolean( input_options, "UNICODE_CHARACTER_CLASS")) options |= java.util.regex.Pattern.UNICODE_CHARACTER_CLASS;
                if( GetBoolean( input_options, "UNIX_LINES")) options |= java.util.regex.Pattern.UNIX_LINES;
                ...
                java.util.regex.Pattern pattern = java.util.regex.Pattern.compile( input_pattern, options);
                java.util.regex.Matcher matcher = pattern.matcher( input_text);
