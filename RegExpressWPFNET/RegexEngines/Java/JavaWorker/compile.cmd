...
"%JDK_ROOT%\bin\javac" -cp .;safere-0.11.0.jar;json-simple-1.1.1.jar SafeREWorker.java
"%JDK_ROOT%\bin\javac" -cp .;reggie-0.4.0.jar;json-simple-1.1.1.jar ReggieWorker.java
