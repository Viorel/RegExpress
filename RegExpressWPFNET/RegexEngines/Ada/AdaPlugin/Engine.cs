...
class Engine : RegexEngine
{
    ...
    public override string Kind => "Ada GNAT";

    public override string Version => Versions.Ada;

    public override string Name => "Ada (GNAT)";

    public override string Subtitle => $"Ada";
