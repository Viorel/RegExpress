...
class Engine : RegexEngine
{
    ...
    public override string Kind => "TRegEx";

    public override string Version => Versions.CppBuilder;

    public override string Name => "TRegEx";

    public override string Subtitle => "TRegEx";
