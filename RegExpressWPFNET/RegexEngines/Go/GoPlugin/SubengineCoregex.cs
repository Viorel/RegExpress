...
class SubengineCoregex( Options options ) : RegexSubengine
{
    static readonly LazyData<bool /*isPosix*/, FeatureMatrix> LazyFeatureMatrix = new( BuildFeatureMatrix );
    ...
    {
        Debug.Assert( options.Package == PackageEnum.coregex );
    ...
    static FeatureMatrix BuildFeatureMatrix( bool isPosix )
    {
