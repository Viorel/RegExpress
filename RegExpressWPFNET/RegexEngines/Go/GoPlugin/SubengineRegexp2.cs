...
class SubengineRegexp2( Options options ) : RegexSubengine
{
    static readonly LazyData<(bool isECMAScript, bool isRE2), FeatureMatrix> LazyFeatureMatrix = new( d => BuildFeatureMatrix( d.isECMAScript, d.isRE2 ) );
    ...
    {
        FeatureMatrix fm = LazyFeatureMatrix.GetValue( (options.ECMAScript, options.RE2) );
    ...
    static string GetWorkerExePath( )
    {
        ...
        string worker_exe = Path.Combine( assembly_dir, @"Regexp2Worker.bin" );

        return worker_exe;
    }

    static FeatureMatrix BuildFeatureMatrix( bool isECMAScript, bool isRE2 )
    {
