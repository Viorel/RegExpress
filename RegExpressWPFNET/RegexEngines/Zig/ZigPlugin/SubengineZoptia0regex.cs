...
class SubengineZoptia0regex( Options options ) : RegexSubengine
{
    ...
    {
        FeatureMatrix fm = LazyFeatureMatrix.GetValue( options.posix );
    ...
    {
        Debug.Assert( options.Library == RegexLibraryEnum.Zoptia0regex );
        ...
        if( response == null || response.names == null ) throw new Exception( "Null response" );
        ...
        if( response.matches != null )
        {
            ...
            foreach( int[] m in response.matches )
            {
    ...
    static string GetWorkerExePath( )
    {
        ...
        string worker_exe = Path.Combine( assembly_dir, @"Zoptia0regexWorker.bin" );

        return worker_exe;
    }

    static FeatureMatrix BuildFeatureMatrix( bool posix )
    {
        return new FeatureMatrix
        {
            ...
            InsideSets_Class_dD = !posix,
            InsideSets_Class_hHhexa = false,
            InsideSets_Class_hHhorspace = false,
            InsideSets_Class_lL = false,
            InsideSets_Class_R = false,
            InsideSets_Class_sS = !posix,
            InsideSets_Class_sSx = false,
            InsideSets_Class_uU = false,
            InsideSets_Class_vV = false,
            InsideSets_Class_wW = !posix,
            InsideSets_Class_X = false,
            InsideSets_Class_pP = !posix,
            InsideSets_Class_pPBrace = !posix,
            ...
            NamedGroup_LtGt = !posix,
            NamedGroup_PLtGt = !posix,
            BalancingGroup = false,
            CapturingGroup = false,
            DuplicateGroupName = !posix,

            NoncapturingGroup = !posix,
